...
export class AIPlayer extends Player {
     ...
     */
    public getBestMove(board: Board, opponentSymbol: CellValue): number {
     ...
     */
    private findWinningMove(board: Board, symbol: CellValue): number | null {
        const emptyCells = board.getEmptyCells();
     ...
     */
    private getStrategicOpeningMove(emptyCells: number[]): number {
