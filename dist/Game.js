...
export class Game {
     ...
     */
    private handleSymbolSelect(symbol) {
     ...
     */
    private handleFirstPlayerSelect(first: 'player' | 'computer') {
    ...
    /**
     * Checks if the game h (win or draw)
     ...
     * Handles a win
     */
    private handleWin(winner, combination) {
        this.gameState = 'won';
        this.ui.disableCells();
